...
| [Simulation declaration](simulation-declaration.md) | ECoRA's abstraction registry, claim fidelity and checklist status against the repository's [simulation framework](../../research/simulation/README.md) |
